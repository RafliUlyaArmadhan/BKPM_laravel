                        ...
                        <form action="{{ route('pendidikan.store') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="tingkatan" required>
                                    ...
                                    <option value="SMA/SMK" {{ old('tingkatan') == 'SMA/SMK' ? 'selected' : '' }}>SMA/SMK</option>
                                    <option value="D3" {{ old('tingkatan') == 'D3' ? 'selected' : '' }}>D3</option>
                                    <option value="D4/S1" {{ old('tingkatan') == 'D4/S1' ? 'selected' : '' }}>D4/S1</option>
                                    <option value="S2" {{ old('tingkatan') == 'S2' ? 'selected' : '' }}>S2</option>
                                    <option value="S3" {{ old('tingkatan') == 'S3' ? 'selected' : '' }}>S3</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="tahun_keluar" value="{{ old('tahun_keluar') }}" required>
                            </div>
